...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { First_name: @login.First_name, Last_name: @login.Last_name, Phone_number: @login.Phone_number, email_id: @login.email_id }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { First_name: @login.First_name, Last_name: @login.Last_name, Phone_number: @login.Phone_number, email_id: @login.email_id }
    assert_redirected_to login_path(assigns(:login))
  end
